...
test.beforeEach(async ({ page }) => {
  ...
  test.describe('Study Tour -by Ryan', () => {
    ...
    test.beforeEach(async ({ page }) => {
      ...
      // 1.Locator all information of 'Study tour'.
      ...
      test('Study tour clickable  -by Ryan', async ({ page }) => {
        //get all information of family activities
        let contentHtml = await page.locator('div.parent-child.box_white').locator('.ulPicTxtB').locator('li');;
